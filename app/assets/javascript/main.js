...
if (window.location.href.indexOf('help') > 0) {
  ...
  if (window.location.href.indexOf('dashboard') > 0) {
    $('a.nhsuk-account-navigation__link-v9').removeClass("nhsuk-account-navigation__link__current-v9");
    $('a.nhsuk-account-navigation__link-v9[href$="/v10/dashboard"]').addClass("nhsuk-account-navigation__link__current-v9");
  }
  
  if (window.location.href.indexOf('all-applications') > 0) {
    $('a.nhsuk-account-navigation__link-v9').removeClass("nhsuk-account-navigation__link__current-v9");
    $('a.nhsuk-account-navigation__link-v9[href$="/v10/all-applications"]').addClass("nhsuk-account-navigation__link__current-v9");
  }
  
  if (window.location.href.indexOf('settings') > 0) {
    $('a.nhsuk-account-navigation__link-v9').removeClass("nhsuk-account-navigation__link__current-v9");
    $('a.nhsuk-account-navigation__link-v9[href$="/v10/settings"]').addClass("nhsuk-account-navigation__link__current-v9");
  }
  
  if (window.location.href.indexOf('help') > 0) {
    $('a.nhsuk-account-navigation__link-v9').removeClass("nhsuk-account-navigation__link__current-v9");
    $('a.nhsuk-account-navigation__link-v9[href$="/v10/help"]').addClass("nhsuk-account-navigation__link__current-v9");
  }

  // inviter dev ready current link
